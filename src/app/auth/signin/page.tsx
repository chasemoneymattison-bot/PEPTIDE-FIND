...
import { FlaskConical, Mail, Chrome } from "lucide-react";
    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Welcome to PeptideFind</CardTitle>
          <CardDescription>
            Sign in to save searches, set price alerts, and write reviews.
          </CardDescription>
        </CardHeader>
